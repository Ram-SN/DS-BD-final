...
train_set = spark.read.parquet('hdfs:/user/as12152/subsample_25_train.parquet')
...
test_set = spark.read.parquet('hdfs:/user/as12152/subsample_25_test.parquet')
...
# for 5% sub sample Model Fitting time is 12.63
